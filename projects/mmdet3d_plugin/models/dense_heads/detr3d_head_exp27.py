...
class Detr3DHead(DETRHead):
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        #------ handle the velocity transformation --------------------------------------------------------------------------------------------------------------
        '''
        # This is my course transformation, now I have changed into nuScenes official transformation, that should be more accurate. Pang 06/23/2022.
        print("custom before",radar_front_xyz[10:15,:])
        radar_front_xyz[:,3], radar_front_xyz[:,4] = -radar_front_xyz[:,4].copy(), radar_front_xyz[:,3].copy() # radar front vx and vy
        radar_front_xyz[:,5], radar_front_xyz[:,6] = -radar_front_xyz[:,6].copy(), radar_front_xyz[:,5].copy() # radar front vx_comp and vy_comp
        radar_front_left_xyz[:,3], radar_front_left_xyz[:,4] = -radar_front_left_xyz[:,3].copy(), -radar_front_left_xyz[:,4].copy() # radar front left vx and vy
        radar_front_left_xyz[:,5], radar_front_left_xyz[:,6] = -radar_front_left_xyz[:,5].copy(), -radar_front_left_xyz[:,6].copy() # radar front left vx_comp and vy_comp
        # radar front right is same as lidar top, so, no need to change!!!!!
        radar_back_left_xyz[:,3], radar_back_left_xyz[:,4] = radar_back_left_xyz[:,4].copy(), -radar_back_left_xyz[:,3].copy() # radar back left vx and vy
        radar_back_left_xyz[:,5], radar_back_left_xyz[:,6] = radar_back_left_xyz[:,6].copy(), -radar_back_left_xyz[:,5].copy() # radar back left vx_comp and vy_comp
        radar_back_right_xyz[:,3], radar_back_right_xyz[:,4] = radar_back_right_xyz[:,4].copy(), -radar_back_right_xyz[:,3].copy() # radar back right vx and vy
        radar_back_right_xyz[:,5], radar_back_right_xyz[:,6] = radar_back_right_xyz[:,6].copy(), -radar_back_right_xyz[:,5].copy() # radar back right vx_comp and vy_comp
        print("custom",radar_front_xyz[10:15,:])'''
        #---------------------------------------------------------------------------------------------------------------------------------------------------------
