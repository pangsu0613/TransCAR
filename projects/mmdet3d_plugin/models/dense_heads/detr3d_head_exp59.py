...
class Detr3DHead(DETRHead):
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        combined_radar_feat = radar_pos_feat + radar_feat  #[1,1500,256]
        ...
        object_length = (tmp[...,3].exp())/2.0 - 1.0
        object_length = torch.clamp(object_length, min=0.0)
        object_rot_sin = -tmp[...,6]
        object_rot_cos = -tmp[...,7]
        #print("look at here:::",reference_points_clone_front[...,0:1].shape,reference_points_clone_front[...,1].shape,object_length.shape,object_rot_cos.shape)
        reference_points_clone_front[..., 0] = reference_points_clone_front[..., 0] + object_length*object_rot_sin  #front x
        reference_points_clone_front[..., 1] = reference_points_clone_front[..., 1] + object_length*object_rot_cos  #front y
        reference_points_clone_rear[..., 0] = reference_points_clone_rear[..., 0] - object_length*object_rot_sin    #rear x
        reference_points_clone_rear[..., 1] = reference_points_clone_rear[..., 1] - object_length*object_rot_cos    #rear y
        ...
        attention_mask_center = dist[0]<2.0
        attention_mask_front = dist_front[0]<2.0
        attention_mask_rear = dist_rear[0]<2.0
        ...
        object_length2 = (tmp[...,3].exp())/2.0 - 1.0
        object_length2 = torch.clamp(object_length2, min=0.0)
        object_rot_sin2 = -tmp[...,6]
        object_rot_cos2 = -tmp[...,7]
        #print("look at here:::",reference_points_clone_front[...,0:1].shape,reference_points_clone_front[...,1].shape,object_length.shape,object_rot_cos.shape)
        reference_points_clone_front2[..., 0] = reference_points_clone_front2[..., 0] + object_length2*object_rot_sin2  #front x
        reference_points_clone_front2[..., 1] = reference_points_clone_front2[..., 1] + object_length2*object_rot_cos2  #front y
        reference_points_clone_rear2[..., 0] = reference_points_clone_rear2[..., 0] - object_length2*object_rot_sin2    #rear x
        reference_points_clone_rear2[..., 1] = reference_points_clone_rear2[..., 1] - object_length2*object_rot_cos2    #rear y
        ...
        #dist_min_value,dist_min_ind = torch.min(dist,1)
        attention_mask_center2 = dist2[0]<2.0
        attention_mask_front2 = dist_front2[0]<2.0
        attention_mask_rear2 = dist_rear2[0]<2.0
        ...
        object_length3 = (tmp2[...,3].exp())/2.0 - 1.0
        object_length3 = torch.clamp(object_length3, min=0.0)
        object_rot_sin3 = -tmp2[...,6]
        object_rot_cos3 = -tmp2[...,7]
        #print("look at here:::",reference_points_clone_front[...,0:1].shape,reference_points_clone_front[...,1].shape,object_length.shape,object_rot_cos.shape)
        reference_points_clone_front3[..., 0] = reference_points_clone_front3[..., 0] + object_length3*object_rot_sin3  #front x
        reference_points_clone_front3[..., 1] = reference_points_clone_front3[..., 1] + object_length3*object_rot_cos3  #front y
        reference_points_clone_rear3[..., 0] = reference_points_clone_rear3[..., 0] - object_length3*object_rot_sin3    #rear x
        reference_points_clone_rear3[..., 1] = reference_points_clone_rear3[..., 1] - object_length3*object_rot_cos3    #rear y
        ...
        #dist_min_value,dist_min_ind = torch.min(dist,1)
        attention_mask_center3 = dist3[0]<1.0
        attention_mask_front3 = dist_front3[0]<1.0
        attention_mask_rear3 = dist_rear3[0]<1.0
