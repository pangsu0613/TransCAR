...
def prepare_mask(tmp, eps_range, eps_rot):
    ...
    tmpc_corners_1x = tmpc[...,0] + (tmpc[...,3].exp()/2 * (-tmpc[...,6])) - (tmpc[...,2].exp()/2 * (-tmpc[...,7])) # x+l/2*rot_consine - w/2*rot_sine
    tmpc_corners_2x = tmpc[...,0] + (tmpc[...,3].exp()/2 * (-tmpc[...,6])) + (tmpc[...,2].exp()/2 * (-tmpc[...,7])) # x+l/2*rot_consine + w/2*rot_sine
    tmpc_corners_3x = tmpc[...,0] - (tmpc[...,3].exp()/2 * (-tmpc[...,6])) + (tmpc[...,2].exp()/2 * (-tmpc[...,7])) # x-l/2*rot_consine + w/2*rot_sine
    tmpc_corners_4x = tmpc[...,0] - (tmpc[...,3].exp()/2 * (-tmpc[...,6])) - (tmpc[...,2].exp()/2 * (-tmpc[...,7])) # x-l/2*rot_consine - w/2*rot_sine
    # [1,900]
    tmpc_corners_1y = tmpc[...,1] + (tmpc[...,3].exp()/2 * (-tmpc[...,7])) + (tmpc[...,2].exp()/2 * (-tmpc[...,6])) # x+l/2*rot_consine - w/2*rot_sine
    tmpc_corners_2y = tmpc[...,1] + (tmpc[...,3].exp()/2 * (-tmpc[...,7])) - (tmpc[...,2].exp()/2 * (-tmpc[...,6])) # x+l/2*rot_consine + w/2*rot_sine
    tmpc_corners_3y = tmpc[...,1] - (tmpc[...,3].exp()/2 * (-tmpc[...,7])) - (tmpc[...,2].exp()/2 * (-tmpc[...,6])) # x-l/2*rot_consine + w/2*rot_sine
    tmpc_corners_4y = tmpc[...,1] - (tmpc[...,3].exp()/2 * (-tmpc[...,7])) + (tmpc[...,2].exp()/2 * (-tmpc[...,6])) # x-l/2*rot_consine - w/2*rot_sine
...
class Detr3DHead(DETRHead):
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        tmpc_range_cat, tmpc_rot_cat, tmpc_range_mid_cat, tmpc_rot_mid_cat, tmpc_range_diff, tmpc_rot_diff, corners_point = prepare_mask(tmp, 0.25, 0.0)
        # calculate Distance
        ...
        #+++++++++++++++++++++++++++ frustum idea, Pang  06/20/2022
        tmpc_range_cat2, tmpc_rot_cat2, tmpc_range_mid_cat2, tmpc_rot_mid_cat2, tmpc_range_diff2, tmpc_rot_diff2, corners_point2 = prepare_mask(tmp, 0.125, 0.0)
        # calculate Distance
