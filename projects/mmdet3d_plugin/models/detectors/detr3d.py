...
class Detr3D(MVXTwoStageDetector):
    ...
    def simple_test_pts(self, x, img_metas, rescale=False):
        ...
        # bbox3d2result is used to convert detection results to a list of numpy arrays.
        # defined in mmdet3d/core/bbox/transforms.py
        bbox_results = [
    ...
    def simple_test(self, img_metas, img=None, rescale=False):
        ...
        ### simple_test_pts is Detr3D and image_backbone
